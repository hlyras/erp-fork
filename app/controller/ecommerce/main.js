...
ecommerceController.manage = async (req, res) => {
  if (!await userController.verifyAccess(req, res, ['adm', 'pro-man', 'log-pac', 'pro-ass', 'pro-sto', 'adm-man', 'fin-ass', 'com-ass'])) {
    return res.redirect('/');
  };
...
ecommerceController.report = async (req, res) => {
  if (!await userController.verifyAccess(req, res, ['adm', 'pro-man', 'log-pac', 'pro-ass', 'adm-man', 'sto-man'])) {
    return res.redirect('/');
  };
