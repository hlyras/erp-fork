...
router.get("/report/customer", lib.route.toHttps, saleController.report.customer.index);
router.post("/report/customer/filter", lib.route.toHttps, saleController.report.customer.filter);
