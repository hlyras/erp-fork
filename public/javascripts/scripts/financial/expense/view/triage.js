	...
	html += "<div class='box b1 container ground border-explicit-2 padding-5 margin-top-5'>";
		...
		if(expense.payment_method == "Boleto"){
			...
			html += "<div class='box b1 container border pointer opacity-in-08 margin-top-5 padding-5'>";
				html += "<div class='mobile-box b8-9 center em08 padding-5 wrap'>"+expense.billet_code+"</div>";
				html += "<div class='mobile-box b9 center'><img class='width-25' src='/images/icon/copy.png'></div>";
			html += "</div>";
			...
			html += "<div class='box b1 container margin-top-5'>";
				...
				html += "<div class='mobile-box a8-9 em09 padding-5 border center'>"+expense.pix_key+"</div>";
				html += "<div class='mobile-box b9 center'><img class='width-25 opacity-in-08 pointer' src='/images/icon/copy.png'></div>";
			html += "</div>";
