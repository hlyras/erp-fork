const OutcomeOriginView = {};

OutcomeOriginView.show = (origin) => {
	let html = "";
	html += "<div class='mobile-box b4 em11 bold avant-garde center tbl-show-link nowrap' onclick='OutcomeOriginController.show(" + origin.id + ")'>" + origin.id + "</div>";
...
OutcomeOriginView.filter = (origins, pagination) => {
	if (origins.length) {
		let html = "";
		...
		for (let i = pagination.page * pagination.pageSize; i < origins.length && i < (pagination.page + 1) * pagination.pageSize; i++) {
			...
			html += "<div class='mobile-box b7 border-explicit avant-garde bold center nowrap tbl-show-link' onclick='OutcomeOriginController.show(" + origins[i].id + ")'>" + origins[i].id + "</div>";
			html += "<div class='mobile-box b4-7 padding-5 v-center'>" + origins[i].name + "</div>";
			html += "<div class='mobile-box b7 padding-5 margin-top-5 center'><img class='icon size-20' src='/images/icon/edit.png' onclick='OutcomeOriginController.edit(" + origins[i].id + ")'></div>";
			html += "<div class='mobile-box b7 padding-5 margin-top-5 center'><img class='icon size-20' src='/images/icon/trash.png' onclick='OutcomeOriginController.delete(" + origins[i].id + ")'></div>";
			html += "</div>";
		};
...
const OutcomeOriginPaymentView = {};
...
OutcomeOriginPaymentView.filter = (payments, pagination) => {
	if (payments.length) {
		let html = "";
		for (let i = pagination.page * pagination.pageSize; i < payments.length && i < (pagination.page + 1) * pagination.pageSize; i++) {
			html += "<div class='box b1 container border-explicit padding-5 margin-top-5'>";
			html += "<div class='mobile-box b7 border-explicit avant-garde bold center nowrap tbl-show-link' onclick='OutcomeOriginPaymentController.show(" + payments[i].id + ")'>" + payments[i].id + "</div>";
			html += "<div class='mobile-box b4-7 padding-5 v-center'>" + payments[i].method + "</div>";
			html += "<div class='mobile-box b7 padding-5 margin-top-5 center'><img class='icon size-20' src='/images/icon/edit.png' onclick='OutcomeOriginPaymentController.edit(" + payments[i].id + ")'></div>";
			html += "<div class='mobile-box b7 padding-5 margin-top-5 center'><img class='icon size-20' src='/images/icon/trash.png' onclick='OutcomeOriginPaymentController.delete(" + payments[i].id + ")'></div>";
...
OutcomeOriginPaymentView.show = (payment) => {
	...
	html += "<div class='mobile-box b7 padding-5 margin-top-5 center'><img class='icon size-20' src='/images/icon/edit.png' onclick='OutcomeOriginPaymentController.edit(" + payment.id + ")'></div>";
	html += "<div class='mobile-box b7 padding-5 margin-top-5 center'><img class='icon size-20' src='/images/icon/trash.png' onclick='OutcomeOriginPaymentController.delete(" + payment.id + ")'></div>";
