...
Sale.view.metrics = (sales, days) => {
	let metrics_box = document.getElementById("sale-metrics-box");
	metrics_box.innerHTML = "";
	...
	let invoicing_div = lib.element.create("div", {
		class: "box b4 container ground padding-10 border-lg-st radius-5 pointer"
	});
	invoicing_div.append(lib.element.create("div", { class: "box b1 lucida-grande bold" }, "Faturamento"));
	invoicing_div.append(lib.element.create("div", { class: "box b1 lucida-grande em09" }, `R$${metrics.invoicing.toFixed(2)}` || `R$${0.00}`));
	metrics_box.append(invoicing_div);

	let ticket_div = lib.element.create("div", {
		class: "box b4 container ground padding-10 border-lg-st radius-5 pointer"
	});
	ticket_div.append(lib.element.create("div", { class: "box b1 lucida-grande bold" }, "Ticket médio"));
	ticket_div.append(lib.element.create("div", { class: "box b1 lucida-grande em09" }, `R$${metrics.ticket.toFixed(2)}` || `R$${0.00}`));
	metrics_box.append(ticket_div);

	let estimated_invoicing_div = lib.element.create("div", {
		class: "box b4 container ground padding-10 border-lg-st radius-5 pointer"
	});
	estimated_invoicing_div.append(lib.element.create("div", { class: "box b1 lucida-grande bold" }, "Faturamento estimado"));
	estimated_invoicing_div.append(lib.element.create("div", { class: "box b1 lucida-grande em09" }, `R$${metrics.estimated_invoicing.toFixed(2)}` || `R$${0.00}`));
	metrics_box.append(estimated_invoicing_div);

	console.log(sales.length);

	let sale_amount_div = lib.element.create("div", {
		class: "box b4 container ground padding-10 border-lg-st radius-5 pointer"
	});
	sale_amount_div.append(lib.element.create("div", { class: "box b1 lucida-grande bold" }, "Quantidade de vendas"));
	sales.length == 1 && sale_amount_div.append(lib.element.create("div", { class: "box b1 lucida-grande em09" }, `${sales.length} venda`));
	sales.length != 1 && sale_amount_div.append(lib.element.create("div", { class: "box b1 lucida-grande em09" }, `${sales.length} vendas` || `${sales.length} vendas`));
	metrics_box.append(sale_amount_div);
};
