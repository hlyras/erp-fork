...
if (Sale.controller.payment_method) {
	Sale.controller.payment_method.addEventListener("change", event => {
		...
		if (event.target.value === "Cartão de crédito") {
			...
			html += "<option value='4x'>4x</option>";
			html += "<option value='5x'>5x</option>";
			html += "<option value='6x'>6x</option>";
			html += "<option value='7x'>7x</option>";
			html += "<option value='8x'>8x</option>";
			html += "<option value='9x'>9x</option>";
			html += "<option value='10x'>10x</option>";
			html += "<option value='11x'>11x</option>";
			html += "<option value='12x'>12x</option>";
			...
			html += "<option value='50%/50%'>50%/50%</option>";
		}
