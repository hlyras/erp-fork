...
lib.Query = function(table) {
	...
	this.period = function(dateProp, period) {
		if(period[0] && period[1]){
			this.period = true;

			this.query += "WHERE "+dateProp+">='"+period[0]+"' AND "+dateProp+"<='"+period[1]+"' ";
		};
		return this;
	};
